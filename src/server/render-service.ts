...
import { NgModuleFactory, Type, CompilerFactory, Compiler, InjectionToken } from '@angular/core';
                ...
                .then(factory => {
                    return renderModuleFactory(factory, {
                        ...
                        extraProviders: [
                            ...
                            {
                                provide: new InjectionToken<any>('sockifyServer'),
                                useValue: require('./sockify-server').sockifyServer(8098)
                            }
                        ]
                    });
                })
